...
│   └── robot.py
└── archivos_prueba/
    ├── proveedores_prueba.xlsx      ← 54 filas válidas + 4 inválidas (12 países)
    └── proveedores_prueba_2.xlsx    ← 54 filas válidas + 5 inválidas (20 países)
```
...
4. En Terminal 2 se ve:
   ...
   [robot] 58 filas, columnas: ['nit_empresa', 'nombre_empresa', 'pais', 'estado_registro']
   [robot] validos: 54 | saltados: 4
   [robot] listo! insertados=54 duplicados=0
   ```
5. Los proveedores aparecen en la tabla con badge **Automático** (54 registros, 4 filas inválidas fueron saltadas)
